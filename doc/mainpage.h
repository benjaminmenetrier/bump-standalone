 ...
 *
 * Code size and characterics can be found in the <a target="_blank" href="http://benjaminmenetrier.free.fr/hdiag_nicas/html/CLOC_REPORT.html">CLOC report</a>.
 *
 * \section license License
 * The code is distributed under the CeCILL-B license (in English: <a target="_blank" href="http://benjaminmenetrier.free.fr/hdiag_nicas/html/MF_LICENSE.html">LICENSE</a> or in French: <a target="_blank" href="http://benjaminmenetrier.free.fr/hdiag_nicas/html/MF_LICENCE.html">LICENCE</a>).
 *
