...
! Local variables
integer :: jsub,il0,jl0r,jc3,ic1a
real(kind_real) :: den
...
do il0=1,geom%nl0
   ...
   do ic1a=1,hdata%nc1a
      ...
      do iscales=1,lct_blk%nscales
         ...
         minim%guess(sum(lct_blk%ncomp)+1:sum(lct_blk%ncomp)+lct_blk%nscales) = 1.0/float(lct_blk%nscales)
         minim%norm(sum(lct_blk%ncomp)+1:sum(lct_blk%ncomp)+lct_blk%nscales) = 1.0/float(lct_blk%nscales)
         minim%binf(sum(lct_blk%ncomp)+1:sum(lct_blk%ncomp)+lct_blk%nscales)= 0.0
         minim%bsup(sum(lct_blk%ncomp)+1:sum(lct_blk%ncomp)+lct_blk%nscales) = 1.0
      end do
      ...
      lct_blk%coef(:,ic1a,il0) = minim%x(sum(lct_blk%ncomp)+1:sum(lct_blk%ncomp)+lct_blk%nscales)
