...
logical :: double_fit(0:nvmax),lhomh,lhomv,lct_diag(nscalesmax),lct_write_cor,nonunit_diag,lsqrt,fast_sampling,network
logical :: forced_radii,write_grids,grid_output
real(kind_real) :: mask_th(nvmax),Lcoast,rcoast,dc,vbal_rad,var_rhflt,local_rad,adv_rad,adv_rhflt,rvflt,lct_qc_th,lct_qc_max
real(kind_real) :: lon_ldwv(nldwvmax),lat_ldwv(nldwvmax),diag_rhflt,resol,rh,rv,londir(ndirmax),latdir(ndirmax),grid_resol
...
namelist/fit_param/minim_algo,fit_type,double_fit,lhomh,lhomv,rvflt,lct_nscales,lct_diag,lct_qc_th,lct_qc_max,lct_write_cor
...
call mpl%f_comm%broadcast(nam%lct_qc_th,mpl%ioproc-1)
call mpl%f_comm%broadcast(nam%lct_qc_max,mpl%ioproc-1)
call mpl%f_comm%broadcast(nam%lct_write_cor,mpl%ioproc-1)
...
call mpl%write(lncid,'lct_qc_th',nam%lct_qc_th)
call mpl%write(lncid,'lct_qc_max',nam%lct_qc_max)
call mpl%write(lncid,'lct_write_cor',nam%lct_write_cor)
