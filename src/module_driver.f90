...
use module_obsop, only: compute_obsop
...
if (.false.) then
   !----------------------------------------------------------------------
   ! Compute observation operator interpolation
   !----------------------------------------------------------------------

   write(mpl%unit,'(a)') '-------------------------------------------------------------------'
   write(mpl%unit,'(a)') '--- Compute observation operator interpolation'

   call compute_obsop(ndata%nc0,ndata%nl0,ndata%rng,ndata%lon,ndata%lat,ndata%mask,ndata%ic0_to_iproc,ndata%ic0_to_ic0a)
